...
function NavBar() {
  ...
  return (
    <nav className="bg-[#f2f0e4] sticky top-0 relative z-10 w-full border-b border-gray-300">
        ...
        <div className="hidden sm:flex items-center">
          <div className="relative">
            ...
            >
              ...
              <span className="eagle-lake-regular text-lg">
      ...
      {menuOpen && (
        <div className="sm:hidden bg-[#f2f0e4] border-t border-gray-300 eagle-lake-regular z-20 relative">
          <Link
            to="/index"
      ...
      {/* Backdrop for closing dropdowns - FIXED */}
